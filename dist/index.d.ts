...
declare const make: (config: OpenAIConfig) => Effect.Effect<Http.client.Client.Default, never, {
    readonly models: Effect.Effect<never, Http.error.HttpClientError | _effect_schema_ParseResult.ParseError, readonly Model[]>;
}>;
interface OpenAI extends Effect.Effect.Success<ReturnType<typeof make>> {
}
declare const OpenAI: Context.Tag<OpenAI, OpenAI>;
